...
public class Product {
    ...
    public enum Step {
        ...
        PRODUCT_VARIANT,     // ordinal 2
        PRODUCT_IMAGE,       // ordinal 3
        PRODUCT_BRAND_AND_TAGS, // ordinal 4
        LIVE,                // ordinal 5
        CATALOG_SELECTED     // ordinal 6 — seller picked from standard catalog (skip attributes + images)
    }
}
